...
call IsMatchesInIsolatedLine('', ['Foo', 'MissingOpeningTag', 'bar', 'baz', 'distinctive', 'doubled', 'fooxy', 'prefix:foo', 'prefix:fox', 'right', 'ring', 'root', 'runtime', 'suffix:foo'], 'all matches')
call vimtest#Quit()
